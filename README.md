...
| [Day 4](./src/bin/04.rs) | `33.2µs` | `33.9µs` |
| [Day 5](./src/bin/05.rs) | `29.2µs` | `35.8µs` |
| [Day 6](./src/bin/06.rs) | `3.3µs` | `12.1µs` |
| [Day 7](./src/bin/07.rs) | `92.6µs` | `90.5µs` |
| [Day 8](./src/bin/08.rs) | `43.4µs` | `153.5µs` |
| [Day 9](./src/bin/09.rs) | `301.3µs` | `340.2µs` |
| [Day 10](./src/bin/10.rs) | `2.6µs` | `2.9µs` |
| [Day 11](./src/bin/11.rs) | `9.0µs` | `3.9ms` |
| [Day 12](./src/bin/12.rs) | `748.5µs` | `522.3µs` |
| [Day 13](./src/bin/13.rs) | `210.7µs` | `304.2µs` |
| [Day 14](./src/bin/14.rs) | `504.4µs` | `2.0ms` |
| [Day 15](./src/bin/15.rs) | `4.1µs` | `29.0ms` |
| [Day 16](./src/bin/16.rs) | `111.5ms` | `-` |
| [Day 19](./src/bin/19.rs) | `213.6ms` | `917.8ms` |
